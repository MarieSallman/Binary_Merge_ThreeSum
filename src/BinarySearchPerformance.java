...
public class BinarySearchPerformance {
    ...
    static int MAXINPUTSIZE  = 67108864;
    ...
    public static void main(String[] args) {
        ...
        long[] testList = createSortedntegerList(7);
        long testSearchKey = (long) (0 + Math.random() * (testList[testList.length-1]));
        long foundIndex = binarySearch(testSearchKey, testList);
        System.out.println("Searching for: " + testSearchKey);
        printArray(testList);
        System.out.println("Index: " + foundIndex);

        long[] testList2 = createSortedntegerList(20);
        long testSearchKey2 = (long) (0 + Math.random() * (testList2[testList2.length-1]));
        long foundIndex2 = binarySearch(testSearchKey2, testList2);
        System.out.println("Searching for: " + testSearchKey2);
        printArray(testList2);
        System.out.println("Index: " + foundIndex2);

        long[] testList3 = createSortedntegerList(40);
        long testSearchKey3 = (long) (0 + Math.random() * (testList3[testList3.length-1]));
        long foundIndex3 = binarySearch(testSearchKey3, testList3);
        System.out.println("Searching for: " + testSearchKey3);
        printArray(testList3);
        System.out.println("Index: " + foundIndex3);
